...
contract DSRTest is DSTest {
    ...
    function test_save_0d() public {
        assertEq(vat.usdv(self), rad(100 ether));

        pot.join(100 ether);
        assertEq(wad(vat.usdv(self)),   0 ether);
        assertEq(pot.pie(self),      100 ether);

        pot.drip();

        pot.exit(100 ether);
        assertEq(wad(vat.usdv(self)), 100 ether);
    }
    function test_save_1d() public {
        ...
        assertEq(pot.pie(self), 100 ether);
        pot.exit(100 ether);
        assertEq(wad(vat.usdv(self)), 105 ether);
    }
    ...
    function test_save_multi() public {
        ...
        pot.drip();
        pot.exit(50 ether);
        assertEq(wad(vat.usdv(self)), 52.5 ether);
        ...
        pot.drip();
        pot.exit(50 ether);
        assertEq(wad(vat.usdv(self)), 110.25 ether);
